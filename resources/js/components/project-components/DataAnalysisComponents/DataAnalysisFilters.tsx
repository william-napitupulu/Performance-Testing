...
export const DataAnalysisFilters = React.memo(function DataAnalysisFilters({ onFilterChange }: DataAnalysisFiltersProps) {
    ...
    return (
        <tr className="border-b border-blue-100 bg-blue-50/30 dark:border-blue-800/50 dark:bg-blue-900/10">
            {/* No column - empty */}
            ...
            <td className="px-6 py-3">
                <Input
                    ...
                    className="h-8 w-full bg-white text-[11px] focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:focus:ring-blue-400"
                />
            </td>
