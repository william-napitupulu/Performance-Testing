...
export type { SharedPerformanceData as PerformanceData };
export type { InputTag as InputTagType };
export type { ExistingInput as ExistingInputType };
export type { InputTagsData as InputTagsDataType }; 