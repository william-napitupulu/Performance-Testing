...
export const UniversalTabProvider: React.FC<UniversalTabProviderProps> = ({
  sharedData,
  children,
  onDataSaved,
  inputTagsData,
  ...
  return (
    <UniversalTabContext.Provider value={{ dataHook, actionsHook, mInput }}>
      {children}
    </UniversalTabContext.Provider>
  );
};
  ...
  return React.memo(function UniversalTabComponent(props: {
    ...
    return (
      <UniversalTabProvider
        ...
        mInput={tabNumber}
      >
        <UnifiedTabTemplate tabNumber={tabNumber} sharedData={props.sharedData} inputTagsData={props.inputTagsData} onDataSaved={props.onDataSaved} />
      </UniversalTabProvider>
    );
  });
};
