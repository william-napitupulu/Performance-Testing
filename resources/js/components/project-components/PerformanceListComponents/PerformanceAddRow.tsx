...
export function PerformanceAddRow({
  ...
  const inputClasses = "w-full px-3 py-1 text-sm border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-600";
    ...
    <tr className="bg-green-50 dark:bg-green-900/10">
      ...
      <td className={cellClasses}>
        <div className="relative">
          ...
          />
          {showTooltip && (
            <div className="absolute top-full left-0 mt-1 px-2 py-1 bg-red-500 text-white text-xs rounded shadow-lg">
              {tooltipMessage}
            </div>
          )}
        </div>
