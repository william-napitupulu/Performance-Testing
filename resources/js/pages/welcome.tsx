...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Performance Test - Welcome">
            </Head>
                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]">
                            ...
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g className="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:translate-y-4 starting:opacity-0">
                                    <path
                                ...
                                <g
                                    ...
                                    className="transition-all delay-300 translate-y-0 opacity-100 duration-750 starting:translate-y-4 starting:opacity-0"
                                >
                                    <path
